...
class CLIPT5Model(VQAScoreModel):
    ...
    def forward(self,
        ...
        Parameters: 
            ...
            - question_template: what format the question instruction should take. Default set at top of file
            - answer_template: what format the desired answer should take. Default set at top of file
        """
